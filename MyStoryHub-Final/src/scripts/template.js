  ...
  return `
    <div tabindex="0" class="story-item" data-storyid="${id}">
      ...
      <div class="story-item__body">
        ...
        <div id="story-description" class="story-items__description">
          ${description}
        </div>
...
export function generateStoryDetailsImageTemplate(imageUrl = null, alt = "") {
  if (!imageUrl) {
    return `
      <img class="story-details__image" src="images/placeholder-image.png" alt="Placeholder Image">
    `;
  }
      ...
      <div class="story-details-content">
        ...
        <div class="story-details__content-body">
          ...
          <div class="story-details__map-container">
            ...
            <div class="story-details__location-coordinates" aria-label="Geographic coordinates">
